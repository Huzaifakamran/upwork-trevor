...
training_dataset = pd.read_csv('Nurse-Mi/Training.csv')
test_dataset = pd.read_csv('Nurse-Mi/Testing.csv')
...
doc_dataset = pd.read_csv('Nurse-Mi/doctors_dataset.csv', names = ['Name', 'Description'])
